...
if ($_REQUEST['id']==='1')
 	{
		$producto->marca_editar($_SESSION['marca_codigo'],$_REQUEST['descripcion']);
    }

$producto->marca_ver($_SESSION['marca_codigo']);
	...
	<form id="form1" name="form1" method="post" action="">
	  ...
	  <table width="488" border="0" align="center" cellpadding="0" cellspacing="2">
        ...
        <tr align="left">
          ...
          <td width="22" >:</td>
          <td width="246"><input name="descripcion" type="text" id="descripcion" value="<?php  echo $producto->mar_descripcion; ?>" size="40" />
        ...
        <tr>
          <td align="center"><a href="consultas_generar.php">Regresar</a></td>
          <td align="center">&nbsp;</td>
...
function editar()
{
	...
	document.forms.form1.id.value='1'
  	document.forms.form1.action='editarmarca.php';
