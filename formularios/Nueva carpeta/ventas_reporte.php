    ...
    <td align="center"><form id="form1" name="form1">
      ...
      <table width="800" border="0">
        <tr class="fondonegro">
          ...
          <td width="41%" align="center">Producto</td>
          <td width="14%" align="center">Cantidad</td>
...
function vista_previa(){
	window.open("ventas_reporte_impresion.php?fecha=<?php echo $_REQUEST['fecha'];?>&fecha2=<?php echo $_REQUEST['fecha2'];?>", "_blank", "resizable,height=600,width=800");
}
