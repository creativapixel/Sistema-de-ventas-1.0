...
if ($_REQUEST['id']==='1')
{
	...
	else
	{
		 ...
		 $venta->grabar_venta($_REQUEST['ped_codigo'],$_REQUEST['cli_codigo'],$_REQUEST['tipo_documento'],$_REQUEST['nro_documento'],$_REQUEST['serie_documento'],$_REQUEST['fecha']);
	...
	<form name="form1"  id="form1">
      ...
      <tr>
          ...
          <tr>
			...
			<input name="fecha" type="text" id="fecha" value="<?php echo $pedido->_util->obtiene_fecha($pedido->ped_fecha); ?>" size="10" readonly="readonly" />			
