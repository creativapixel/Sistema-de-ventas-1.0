...
CREATE TABLE detalle_pedidos (
  ...
  pro_id INT NOT NULL,
  ped_id INT NOT NULL,
  dped_cantidad DECIMAL(10,2) NULL,
  dped_unidades DECIMAL(10,2) NULL,
  dped_precio_cantidad DECIMAL(10,2) NULL,
  dped_totalcantidad DECIMAL(10,2) NULL,
  dped_preciounidades DECIMAL(10,2) NULL,
  dped_preciototal DECIMAL(10,2) NULL,
  PRIMARY KEY(dped_id),
  INDEX detalle_pedidos_FKIndex1(ped_id),
  INDEX detalle_pedidos_FKIndex2(pro_id),
  FOREIGN KEY(ped_id)
